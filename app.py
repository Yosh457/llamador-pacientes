...
def create_app():
    ...
    login_manager.login_message = 'Debe iniciar sesión para acceder al Llamador de Pacientes.'
...
if __name__ == '__main__':
    ...
    with app.app_context():
        try:
            ...
            db.create_all()
            print("✅ Llamador Pacientes inicializado. Tablas verificadas en MySQL.")
